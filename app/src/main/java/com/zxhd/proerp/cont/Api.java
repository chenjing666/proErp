...
public class Api {
    ...
    public static final String OUT_WARE_LIST_LINGLIAO = BASE_URL + "outwarehouseController/findAllOutwarehouseApp";//查询出库需求列表(领料)
    ...
    public static final String GOODS_WARE_OUT = BASE_URL + "outdepotController/addOutdepotApp";//出库
    public static final String GOODS_WARE_OUT_OVER = BASE_URL + "outwarehouseController/overOutApp"; //确定结束出库
